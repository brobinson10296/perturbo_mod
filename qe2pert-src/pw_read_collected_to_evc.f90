...
!------------------------------------------------------------------------
SUBROUTINE pw_read_collected_to_evc(dirname, iunit, ik, ik_g, ngk_g, evc)
   !------------------------------------------------------------------------
   !
   ...
   INTEGER, INTENT(in) :: iunit, ik, ik_g, ngk_g(nkstot)
   ...
   !k_points_loop: DO ik = 1, nks
      ...
      !
      igk_l2g_kdip = 0
      CALL pw_gk_l2gmap_kdip( npw_g, ngk_g(ik_g), ngk(ik), igk_l2g, &
                           igk_l2g_kdip )
      !
      evc=(0.0_DP, 0.0_DP)
      !
